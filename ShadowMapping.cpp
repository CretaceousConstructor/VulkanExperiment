...
void ShadowMapping::SetUpUserInput()
{
...
void ShadowMapping::CreateCamera()
{
...
void ShadowMapping::CreateAttachmentImages()
{
...
void ShadowMapping::CreateTextureImages()
{
...
void ShadowMapping::CreateDepthImages()
{
...
void ShadowMapping::CreateGraphicsPiplineLayout()
{
...
void ShadowMapping::CreateGraphicsPipline()
{
...
void ShadowMapping::InitCommandBuffers()
{
...
void ShadowMapping::PrepareModels()
{
...
void ShadowMapping::CommandBufferRecording()
{
...
void ShadowMapping::InitSynObjects()
{
...
void ShadowMapping::UpdateUniformBuffer(uint32_t currentImage)
{
...
void ShadowMapping::CreateFrameBufferScene()
{
...
void ShadowMapping::CreateSceneRenderPass()
{
...
void ShadowMapping::CreateOffSceenRenderPass()
{
...
void ShadowMapping::CreateOffScreenUniformBuffer()
{
...
void ShadowMapping::CreateSceneUniformBuffer()
{
...
void ShadowMapping::CreateFramebuffersOffScreen()
{
...
void ShadowMapping::CreatePiplineShadowPass()
{
	...
	//										shadow pass
	/******************************************************************************************************/
	ShaderManager vertex_shader_shadow_pass(std::string("shaders\\shadowmapping\\shadow_mapping_vertex_shader_shadow_pass.spv"), std::string("main"), VK_SHADER_STAGE_VERTEX_BIT, device_manager->GetLogicalDeviceRef());
	ShaderManager fragment_shader_shadow_pass(std::string("shaders\\shadowmapping\\shadow_mapping_fragment_shader_shadow_pass.spv"), std::string("main"), VK_SHADER_STAGE_FRAGMENT_BIT, device_manager->GetLogicalDeviceRef());
...
void ShadowMapping::CreatePiplineScenePass()
{
	...
	ShaderManager vertex_shader_scene_pass(std::string("shaders\\shadowmapping\\shadow_mapping_vertex_shader_scene_pass.spv"), std::string("main"), VK_SHADER_STAGE_VERTEX_BIT, device_manager->GetLogicalDeviceRef());
	ShaderManager fragment_shader_scene_pass(std::string("shaders\\shadowmapping\\shadow_mapping_fragment_shader_scene_pass.spv"), std::string("main"), VK_SHADER_STAGE_FRAGMENT_BIT, device_manager->GetLogicalDeviceRef());
...
void ShadowMapping::UpdateLight()
{
...
void ShadowMapping::UpdateUniformBufferOffscreen(uint32_t currentImage)
{
...
void ShadowMapping::UpdateUniformBuffersScene(uint32_t currentImage)
{
...
void ShadowMapping::CleanUpModels()
{
}

void ShadowMapping::CleanUpDescriptorSetLayoutAndDescriptorPool()
{
}

void ShadowMapping::CleanUpCommandBuffersAndCommandPool()
{
}

void ShadowMapping::CleanUpSyncObjects()
{
}

void ShadowMapping::CleanupFrameBuffers()
{
}

void ShadowMapping::CleanUpPiplineAndPiplineLayout()
{
}

void ShadowMapping::CleanUpRenderPass()
{
}

void ShadowMapping::CleanUpImages()
{
}
