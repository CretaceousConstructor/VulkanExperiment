...
void VkImageWrapper::InitImageView(VkFormat format, VkImageAspectFlags aspectFlags)
{
...
void VkImageWrapper::TransitionImageLayout( VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, VkCommandPool& command_pool, VkDevice& device,  VkQueue& command_quque)
{
	VkCommandBuffer commandBuffer = VkCommandManager::BeginSingleTimeCommands(command_pool,device);
