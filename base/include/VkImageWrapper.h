...
public:
	...
	//预设了miplevelcount和layercount都是1，之后也许需要修改layercount
	void TransitionImageLayout( VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, VkCommandPool& command_pool, VkDevice& device,  VkQueue& command_quque,uint32_t miplevelcount = 1);
