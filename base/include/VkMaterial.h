...
public:
	...
	//static VkPipelineLayout      CreatePipelineLayout(const VkDeviceManager& device_manager,const std::vector<VkDescriptorSetLayout> &other_layouts, const std::vector<VkPushConstantRange> &push_constant_ranges);
	...
	virtual void     ModifyPipelineCI(VkPipelineParameterPack &pipeline_CI) = 0;
