...
PbrRenderingPass::PbrRenderingPass(VkGraphicsComponent &gfx_, VkRenderpassManager &renderpass_manager_, KtxRenderer::RenderpassCommonResources &common_resources_) :
...
void PbrRenderingPass::CreateRenderPass()
{
...
void PbrRenderingPass::CompileShaders()
{
...
void PbrRenderingPass::BeginRenderpass(size_t index, VkCommandBuffer command_buffer) const
{
...
void PbrRenderingPass::RenderpassExecute(VkCommandBuffer command_buffer)
{
