...
//
//
//	models.skybox = std::make_unique<GltfModel>(std::string("../../data/models/cube.gltf"), device_manager, window, window->GetSurface(), graphics_command_pool, transfer_command_buffer);
//	models.object = std::make_unique<GltfModel>(std::string("../../data/cerberus/cerberus.gltf"), device_manager, window, window->GetSurface(), graphics_command_pool, transfer_command_buffer);
//
//
//
//
...
//}
//
//void PbrRenderer::CreateDescriptorPool()
//{
//	// Create the global descriptor pool
//	std::array<VkDescriptorPoolSize, 3> poolSizes{};
//
//	poolSizes[0].type            = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
//	poolSizes[0].descriptorCount = 9;        // 9        uniform_buffers    uniform_buffers_test  uniform_buffers_gs 三个，共3帧。3*3 = 9
//
//	poolSizes[1].type            = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
//	poolSizes[1].descriptorCount = test_model->images.size();
//
//	poolSizes[2].type            = VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
//	poolSizes[2].descriptorCount = 6;        //6          depthcolor 和rcolor 两个，共3帧。2*3 = 6
//
...
//	}
//}
//void PbrRenderer::CreateDescriptorSetLayout()
//{
//	/*
//			Attachment write
//	*/
...
//	LayoutBindingSubpass0_temp.stageFlags         = VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT;
...
//	LayoutBindingSubpass0.push_back(LayoutBindingSubpass0_temp);
//
//	LayoutBindingSubpass0_temp.binding            = 2;        //index  uniform buffer for Geometry shader
//	LayoutBindingSubpass0_temp.descriptorType     = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
//	LayoutBindingSubpass0_temp.descriptorCount    = 1;
...
//	//材质的texture会在set = 1中使用，set 1中的binding 0 还没有被使用
...
//
//	LayoutBindingSubpass1_temp.binding         = 0;        //index  color read
...
//	//subpass0 writing
//	{
//		//Descriptor sets for vs matrix and gs data set = 0
...
//
//			/*
//				Binding 1: VS test purposes uniform buffer
//			*/
//
//			temp_writeDescriptorSet.sType           = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
//			temp_writeDescriptorSet.dstSet          = descriptor_sets_write_subpass0[i];
...
//			temp_writeDescriptorSet.descriptorType  = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
//			temp_writeDescriptorSet.pBufferInfo     = &buffer_info_write_subpass0_test;
//			temp_writeDescriptorSet.descriptorCount = 1;
//			temp_writeDescriptorSet.dstArrayElement = 0;
//			writeDescriptorSets.push_back(temp_writeDescriptorSet);
//
//			/*
//				Binding 2: GS uniform buffer
//			*/
//
//			temp_writeDescriptorSet.sType           = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
//			temp_writeDescriptorSet.dstSet          = descriptor_sets_write_subpass0[i];
...
//		}
//
//		// Descriptor sets for materials set=1
...
//			temp_writeDescriptorSet.descriptorCount = 1;
//			//TODO CHECK THIS dstArrayElement
//			//temp_writeDescriptorSet.dstArrayElement = 0;
//
...
//}
//
//void PbrRenderer::CreateUniformBuffer()
//{
//	//GPU SIDE
...
//}
//
//void PbrRenderer::CreateDepthImages()
//{
...
//}
//
//void PbrRenderer::CreatePiplineSubpass0()
//{
//	//										 subpass0
//	/******************************************************************************************************/
//	/******************************************************************************************************/
...
//}
//
//void PbrRenderer::CreatePiplineSubpass1()
//{
//	/******************************************************************************************************/
...
//}
//
//void PbrRenderer::CreateRenderPass()
//{
...
//	RchannelcolorAttachment.format = swapchain_manager->GetSwapChainImageFormat();        //这里的format是否和上面的一致？
//
...
//}
//
//void PbrRenderer::CreateGraphicsPiplineLayout()
//{
//	{
...
//}
//
//void PbrRenderer::CreateGraphicsPipline()
//{
...
//}
//
//void PbrRenderer::CreateFramebuffers()
//{
...
//}
//
//void PbrRenderer::InitCommandBuffers()
//{
...
//}
//
//void PbrRenderer::CommandBufferRecording()
//{
...
//}
//
//void PbrRenderer::InitSynObjects()
//{
...
//}
//
//void PbrRenderer::CreateTextureImages()
//{
//	//UNORM
...
//
//
//	textures.environment_cube.InitTexture(std::string("../../data/textures/hdr/gcanyon_cube.ktx"), device_manager, window, graphics_command_pool, VK_FORMAT_R16G16B16A16_SFLOAT);
//	textures.environment_cube.InitTextureView(VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT);
//	textures.environment_cube.InitSampler();
//
//	
//
//
...
//}
//
//void PbrRenderer::SetUpUserInput()
//{
...
//}
//
//void PbrRenderer::CreateAttachmentImages()
//{
...
//	{        //images_inflight[imageIndex] 不是 nullptr，说明某一帧的GPU资源正在被以imageIndex为下标的image使用，那么我们就要等待。
...
//}
//
//void PbrRenderer::UpdateUniformBuffer(uint32_t currentImage)
//{
//	ubo.proj   = m_pCamera->GetProj();
//	ubo.view   = m_pCamera->GetView();
...
//}
//
//void PbrRenderer::UpdateCamera(float dt)
//{
...
//	m_pCamera->LookAt(glm::vec3(0.7f, 0.1f, 1.7f), glm::vec3(0.f, 0.f, -1.f), glm::vec3(0., 1., 0.));
//	
//	VkViewport       viewport{};
//	const VkExtent3D extend_of_swap_image = swapchain_manager->GetSwapChainImageExtent();
//	viewport.x                            = 0.0f;
...
//}
//
//void PbrRenderer::CleanUpModels()
//{
//}
//
//void PbrRenderer::CleanUpDescriptorSetLayoutAndDescriptorPool()
//{
...
//}
//
//void PbrRenderer::CleanUpCommandBuffersAndCommandPool()
//{
...
//}
//
//void PbrRenderer::CleanUpSyncObjects()
//{
//	for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
//	{
...
//}
//
//void PbrRenderer::CleanupFrameBuffers()
//{
...
//}
//
//void PbrRenderer::CleanUpPiplineAndPiplineLayout()
//{
